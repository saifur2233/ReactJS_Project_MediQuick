...
const ManufacturerSendDrug = () => {
  ...
  const handleSearchDeug = (event) => {
    ...
    console.log(drugId);
    fetch(
      `https://mediquick-server.onrender.com/api/v1/drug-basket/search/${drugId}`
    )
      .then((res) => res.json())
      .then((result) => {
  ...
  const handleSupplyChain = (event) => {
    ...
    fetch(
      "https://mediquick-server.onrender.com/api/v1/Handoverdata/drug/check",
      {
        method: "POST",
        headers: {
      ...
      .then((data) => {
        if (data === false) {
          ...
          fetch(
            "https://mediquick-server.onrender.com/api/v1/drug-supplychain/addHandover",
            {
              method: "POST",
              headers: {
                "content-type": "application/json",
    ...
    // fetch("https://mediquick-server.onrender.com/api/v1/drug-supplychain/addHandover", {
    //   method: "POST",
    //   headers: {
    //     "content-type": "application/json",
    //   },
