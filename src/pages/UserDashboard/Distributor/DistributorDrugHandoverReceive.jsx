...
const DistributorDrugHandoverReceive = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await fetch(
        `https://mediquick-server.onrender.com/api/v1/Handoverdata/receiver/${reciverAddress}`
      );
  ...
  const handleReceiverAttachSignature = (id) => {
    ...
    fetch(
      `https://mediquick-server.onrender.com/api/v1/Handoverdata/receiver/attachSignature`,
      {
        method: "POST",
        headers: {
  ...
  const handleDrugAddToBasket = (data) => {
    ...
    fetch(
      "https://mediquick-server.onrender.com/api/v1/drug-basket/wallet/addDrug",
      {
        method: "POST",
        headers: {
          "content-type": "application/json",
